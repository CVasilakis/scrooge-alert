...
- **Testing Notifications:** Run `./scripts/run_scraper.sh --test-notification` to send a test payload and verify that the Apprise URLs in your `.env` file are configured correctly.
